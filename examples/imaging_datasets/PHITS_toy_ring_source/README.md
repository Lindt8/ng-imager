...
The source is a "ring source" of 14.1 MeV neutrons (10^7 histories).  It is centered at (0, 3 cm, 4 cm) with its radial extent defined as all points between 4.8 cm and 5.2 cm from the ring's x-axis, illustrated below.
